...
with tf.Session() as sess:  
    ...
    # ca = np.asarray(ca)
    print('\n')
    cv2.imshow('original trump',trump[303])
    cv2.imshow('reconstructed trump',trump_into_trump[3])
    cv2.imshow('trump into cage',trump_morphed_into_cage[3])
    
    cv2.imshow('original cage',cage[3])
    cv2.imshow('reconstructed cage',cage_into_cage[3])
    cv2.imshow('cage into trump',cage_morphed_into_trump[3])
    cv2.waitKey(0)
